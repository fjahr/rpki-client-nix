{
  ...
  inputs = {
    ...
    rpki-client-src = {
      url = "github:rpki-client/rpki-client-portable/cf5bdfba24b683968c406ee516dac65debbe2e69"; # v9.9
      flake = false;
    };
    ...
    rpki-openbsd-src = {
      url = "github:rpki-client/rpki-client-openbsd/65b0882149d7c1a22208b0415b9ece507d8f9522"; # v9.9
      flake = false;
    };
  };
